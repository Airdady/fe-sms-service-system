...
export default function BasicTable() {
  ...
  return (
          ...
          <Container maxWidth="lg" style={{ height: '350px' }}>
            <Grid container style={{ height: '100%' }}>
              <Grid item md={4} style={{ marginTop: '6rem' }}>
                ...
                Help your business establish meaningful connections with customers
                </Typography>
                <Typography variant="p" style={{ color: 'grey' }}>
                Send services and 
                notifications at the right time to keep the company engaged with customers and 
                help the company improve customer engagement,
                </Typography>
                <Box mt={4} display>
   ...
   "line_type": "mobile"
        ...
        <Container>
          <Grid container spacing={3}>
              <Box textAlign="center" mb={3}>
                <Typography variant="h4">Don't let your customers idle 
                they can't afford to wait</Typography>
              </Box>
            <Grid item md={6}>
              <img
                style={{ width: '90%' }}
            ...
            <Grid item md={6}>
              <Box mb={2}>
                <Typography variant="h5">Personalized communication to promote custoumer activity</Typography>
                <Typography variant="subtitle1">
                According to the recent demands of customers, 
              timely send personalized recommendation SMS to promote customer activity.
                </Typography>
              </Box>
            </Grid>
            <Grid item md={6}>
              <Box mb={2}>
                <Typography variant="h5">Increase customer engagement and stickiness</Typography>
                <Typography variant="subtitle1">
                Send notifications of unfinished appointments, services, and 
                reminders at the right time to keep the company engaged with customers and 
                help the company improve customer engagement.
                </Typography>
              </Box>
            </Grid>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item md={6}>
              <Box mb={2}>
                <Typography variant="h5">Timely notification of marketing activities to increase customer conversion</Typography>
                <Typography variant="subtitle1">
                Send the latest activity introduction to customers, 
                effectively reach the target group, 
            ...
            <Grid item md={6}>
              <Box mb={2}>
                <Typography variant="h5">Improve customer experience and extend customer life cycle</Typography>
                <Typography variant="subtitle1">
                Send care and reminders to customers on holidays, 
                members' birthdays and other time nodes, 
                creating experience that customers value in the process of communication.
                </Typography>
              </Box>
            </Grid>
            <Grid item md={6}>
            ...
            <Grid item md={6}>
              <Box mb={2}>
                <Typography variant="h5">Improve customer satisfaction and cultivate loyal customers</Typography>
                <Typography variant="subtitle1">
                By sending survey requests to customers, 
                we help you collect customer feedback, 
                improve your business or products, 
      ...
      <Box p={5} width="100%" bgcolor="#f0f3fb" textAlign="left">
        <Container>
          <Grid container spacing={3}>
            <Box mt={5}>
              <Box textAlign="center" mb={3}>
                <Typography variant="h4">Quality communication technology to create a first-class customer experience</Typography>
              </Box>
              <ProductFeatures />
            </Box>
          </Grid>
        ...
        <Container style={{ transform: 'skewY(0deg)' }}>
          <Box my={5}>
            <Typography variant="h4">15 years of painstaking research to better serve you</Typography>
          </Box>
          ...
          <Grid container spacing={3}>
            <Grid item md={3}>
              <Paper className={classes.paper}>
                <Box className={classes.box} p={3}>
                  <Typography variant="h6">Rich experience in international communications</Typography>
                  <Typography variant="subtitle1" className={classes.p}>
                  In-depth cooperation with hundreds of overseas operators, 
                  multi-protocol docking to ensure that needs are met, 
                  and multiple submission methods to easily reach the world.
                  </Typography>
                </Box>
              </Paper>
            </Grid>
            <Grid item md={3}>
              <Paper className={classes.paper}>
                <Box className={classes.box} p={3}>
                  <Typography variant="h6">Stable and reliable platform</Typography>
                  <Typography variant="subtitle1" className={classes.p}>
                  The platform supports large-capacity, 
                  high-concurrency, 
                  distributed clustering, 
                  high availability, 
                  automatic disaster recovery mechanism, 
                  and highly elastic and scalable network architecture
                  </Typography>
                </Box>
              </Paper>
            </Grid>
            <Grid item md={3}>
              <Paper className={classes.paper}>
                <Box className={classes.box} p={3}>
                  <Typography variant="h6">Flexible billing and low price</Typography>
                  <Typography variant="subtitle1" className={classes.p}>
                  The directly connected channel has low resource prices and high efficiency. 
                  The platform has a flexible billing model, 
            ...
            <Grid item md={3}>
              <Paper className={classes.paper}>
                <Box className={classes.box} p={3}>
                  <Typography variant="h6">High quality service and fast processing</Typography>
                  <Typography variant="subtitle1" className={classes.p}>
      ...
      <Box textAlign="center" mb={3} spacing={3}>
                <Typography variant="h4">Quick access with 4 steps</Typography>
      </Box>
      <Grid container spacing={3}>
        <Grid item md={3}>
          <Paper className={classes.paper}>
        ...
        <Grid item md={3}>
          <Paper className={classes.paper}>
            <Box className={classes.box} p={3}>
              ...
              <Typography variant="h6">Docking adjusting</Typography>              
              <Typography variant="subtitle1" className={classes.p}>
              Adjusting according to mimicking production environment, avoid unknowns in advance</Typography>
            </Box>
          </Paper>
        </Grid>
        <Grid item md={3}>
